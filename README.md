...
<div align="center">
  <table>
    ...
    <tr>
      <td align="center"><b>📞</b></td>
      <td><b>1-to-1 Calling</b> - Real-time voice and video calling powered by Agora RTC Engine with a glassmorphic floating control bar</td>
    </tr>
    <tr>
      <td align="center"><b>🔍</b></td>
...
| **Calling** | agora_rtc_engine, permission_handler |
...
│   │   ├── domain/                # CallRepository interface
│   │   ├── logic/                 # CallBloc, Events, States
│   │   └── presentation/          # CallScreen, CallView
│   │
...
| **📞 1-to-1 Calling** | Voice & Video calling with Agora RTC, PiP local view, active call timers, and glassmorphic bottom controls |
...
- [x] **Audio/Video Calls** (Agora RTC integration)
